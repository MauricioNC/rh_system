...
ActiveRecord::Schema[8.1].define(version: 2026_07_17_045411) do
  ...
  create_table "employments", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "budget_key", null: false
    ...
    t.string "status", default: "Inactivo"
    t.datetime "updated_at", null: false
  ...
  add_foreign_key "position_salaries", "positions"
end
